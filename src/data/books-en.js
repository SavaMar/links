export const books = [
  ...
  },
  {
    ...
    description:
      "A compassionate guide to understanding and healing from the lasting effects of being raised by emotionally immature or unavailable parents. Dr. Lindsay Gibson provides insight into how these dynamics shape adult relationships and offers practical strategies to foster emotional independence and healthier connections.",
    hashtags: [
      "psychology",
      "childhood",
      "family",
    ...
    translation: ["en"],
    quotes: [
      "When you stop reacting to your parents, you reclaim your own emotional world.",
      "Emotionally immature parents can’t give what they never received.",
      "Awareness is the first step toward breaking old patterns and building your own identity.",
    ],
  },
  {
    id: 20,
  ...
  },
  {
    ...
    author: "James Gleick",
    cover: "https://filedn.com/lPmOLyYLDG0bQGSveFAL3WB/Books/en-50.jpg",
    description:
      "James Gleick masterfully unravels the beginnings and impact of chaos theory, tracing its roots from mathematical curiosities to a revolution in how we understand the world. With vivid storytelling, he explores pattern, unpredictability, and the breathtaking intricacies of dynamic systems in nature.",
    hashtags: [
      "science",
      "chaos theory",
      "mathematics",
  ...
  },
  {
    ...
    author: "Alex Hormozi",
    cover: "https://filedn.com/lPmOLyYLDG0bQGSveFAL3WB/Books/en-51.jpg",
    description:
      "A step-by-step manual for generating a consistent stream of qualified leads. Hormozi shows how to build systems that reliably convert strangers into paying customers.",
    hashtags: [
      "marketing",
      "business",
      "sales",
  ...
  },
  {
    ...
    cover: "https://filedn.com/lPmOLyYLDG0bQGSveFAL3WB/Books/en-52.jpg",
    description:
      "The classic and groundbreaking book on the psychology of what makes people say yes. Cialdini uncovers the six universal principles of persuasion with powerful and memorable stories and studies. An essential read for anyone who wants to understand how influence really works.",
    hashtags: [
      "psychology",
      "persuasion",
      "behavior",
  ...
  },
  {
    ...
    cover: "https://filedn.com/lPmOLyYLDG0bQGSveFAL3WB/Books/en-53.jpg",
    description:
      "Nathaniel Branden lays out the fundamental practices that create genuine self-esteem. Insightful and practical, these six pillars are essential for anyone seeking emotional strength and personal confidence.",
    hashtags: [
      "psychology",
      "self-esteem",
      "personal development",
  ...
  },
  {
    ...
    author: "Josh Kaufman",
    cover: "https://filedn.com/lPmOLyYLDG0bQGSveFAL3WB/Books/en-60.jpg",
    description:
      "A comprehensive guide to business fundamentals for entrepreneurs and aspiring business leaders. Josh Kaufman distills the key principles of business management into a practical and actionable framework for success.",
    hashtags: ["business", "entrepreneurship", "management", "leadership"],
    "my-score": 4,
    translation: ["en"],
    quotes: [
  ...
  },
  {
    ...
    author: "Seth Godin",
    cover: "https://filedn.com/lPmOLyYLDG0bQGSveFAL3WB/Books/en-61.jpg",
    description:
      "Seth Godin reveals a new approach to marketing that’s focused on serving, not stealing attention. Learn how to build trust, empathy, and connection — and why marketing is ultimately about making real change.",
    hashtags: ["marketing", "business", "branding", "strategy"],
    "my-score": 5,
    translation: ["en"],
    quotes: [
  ...
  },
  {
    ...
    author: "Blair Enns",
    cover: "https://filedn.com/lPmOLyYLDG0bQGSveFAL3WB/Books/en-62.jpg",
    description:
      "A transformative blueprint for creative professionals and agencies who want to win business on their terms — without speculative work. Learn strategies to position yourself as the expert and command respect and value.",
    hashtags: ["sales", "creative", "business", "negotiation"],
    "my-score": 4,
    translation: ["en"],
    quotes: [
      "Lead the client, don’t follow them.",
      "Declare your expertise.",
      "We will be selective about the clients we take on.",
    ],
  },
  {
    id: 63,
    ...
    author: "Allan Dib",
    cover: "https://filedn.com/lPmOLyYLDG0bQGSveFAL3WB/Books/en-63.jpg",
    description:
      "A fast, simple, and effective way to create a marketing plan that grows your business. Allan Dib breaks down marketing into clear and actionable steps, all on a single page.",
    hashtags: ["marketing", "business", "strategy", "planning"],
    "my-score": 5,
    translation: ["en"],
    quotes: [
      "You don’t need to be a marketing genius to get big results.",
      "A business without a marketing plan is a ship without a rudder.",
  ...
  },
  {
    ...
    author: "Shane Parrish",
    cover: "https://filedn.com/lPmOLyYLDG0bQGSveFAL3WB/Books/en-64.jpg",
    description:
      "The second volume in Shane Parrish's 'Great Mental Models' series, focusing on understanding and applying physics, chemistry, and biology models to better reasoning and decision making.",
    hashtags: ["mental-models", "decision-making", "thinking", "psychology"],
    "my-score": "lifechanging",
    translation: ["en"],
    quotes: [
      "To develop the best judgment, you must constantly upgrade your mental models.",
      "Applying the right model at the right time is the mark of a wise thinker.",
      "The greatest minds are defined by their ability to see things through multiple models and disciplines.",
    ],
  },
  {
    id: 65,
    ...
    author: "Peter Thiel",
    cover: "https://filedn.com/lPmOLyYLDG0bQGSveFAL3WB/Books/en-65.jpg",
    description:
      "Legendary investor Peter Thiel shows how to build startups that create new things. A thought-provoking guide to innovation, progress, and going from nothing to something truly unique.",
    hashtags: ["startups", "business", "innovation", "entrepreneurship"],
    "my-score": "lifechanging",
    translation: ["en"],
    quotes: [
